    ...
    def forward(
        ...
        if inputs_embeds is None:
            (
                ...
                input_ids, position_ids, attention_mask, past_key_values, labels, images, image_num
            )
        ...
        **generation_kwargs,
        ...
        if images is not None:
            (
                ...
                input_ids, None, attention_mask, None, None, images, image_num
            )
        else:
