...
def prepare_config_for_training(
    ...
    if getattr(config, "change_encoder_cfg", None) is None:
        config.chg = model_args.chg
        config.chg_type = model_args.chg_type
        config.from_origin = model_args.from_origin
    ## set default dtype
    ...
    config.tune_cc_projector = training_args.tune_cc_projector
    config.tune_single_projector = training_args.tune_single_projector
    ## set data args
    config.image_aspect_ratio = data_args.image_aspect_ratio
    ## set change caption args
    config.mm_projector_cfg["cc_n_layers"] = model_args.cc_n_layers
    config.mm_projector_cfg["cc_head"] = model_args.cc_head
    config.mm_projector_cfg["cc_dropout"] = model_args.cc_dropout
    config.mm_projector_cfg["from_origin"] = model_args.from_origin
