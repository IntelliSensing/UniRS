...
class ModelArguments:
    ...
    chg: bool = field(default=False)
    chg_type: Optional[str] = field(default='Chg2Cap')
    from_origin: bool = field(default=True)
    cc_n_layers: Optional[int] = field(default=3)
    cc_head: Optional[int] = field(default=8)
    cc_dropout: Optional[float] = field(default=0.)
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    tune_cc_projector: bool = field(default=False)
    tune_single_projector: bool = field(default=False)
